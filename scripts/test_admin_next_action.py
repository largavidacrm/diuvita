...
def main() -> None:
    ...
    for marker in [
        ...
        "function reviewDisplayTitle",
        "function reviewShortUrlLabel",
        "function reviewCandidateUrlLabel",
        ...
        "function reviewGoogleMapsTriageLabel",
        ...
        "Ruta: Filtrar ficha · revisar sus mejoras pendientes · aprobar, rechazar o modificar · volver a lista.",
        "Tu foco",
        "Trabajo Codex",
        "Mejoras seguras",
        "Parado",
