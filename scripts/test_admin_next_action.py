...
def main() -> None:
    ...
    for marker in [
        ...
        "Plan global",
        "Ahora estás aquí",
        "Siguiente clic recomendado",
        "Dónde estamos, qué hacer ahora y qué queda después.",
        "Estamos en control interno: convertir revisiones en fichas fiables.",
        "Ya funciona",
        "Cuello de botella",
        "No activar aún",
        "Auto-publicación",
