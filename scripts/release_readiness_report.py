...
SOURCE_MARKERS = [
    ...
    ("admin source-only manual review clarity", "admin/index.html", "Puedes decidir o modificar esta propuesta manualmente"),
    ...
    ("admin local version fallback warning", "admin/index.html", "Local sin sello de versión"),
    ...
    ("admin review sidebar reset", "admin/index.html", "function resetReviewWorkAreaForNav"),
    ...
    ("admin source job inside proposal", "admin/index.html", "URL oficial para el agente"),
    ("admin specialist quality gate", "admin/index.html", "function specialistNoiseReason"),
    ("admin specialist approval block", "admin/index.html", "Especialistas contiene entradas sospechosas"),
    ("admin in-card field decisions", "admin/index.html", "function reviewSupportsInlineFieldDecision"),
    ("admin in-card field decision history", "admin/index.html", "field_decisions"),
    ...
    ("LLM manual-target route readiness", "scripts/review_proposal_decision_packets.py", "manual_target_prompt_ready"),
    ("LLM manual source scope", "scripts/review_proposal_decision_packets.py", "primary_target_first"),
    ("LLM deprecated Google reviews filter", "scripts/review_proposal_decision_packets.py", "is_deprecated_field"),
    ("LLM actionable decision guard", "scripts/validate_review_decision_suggestion.py", "actionable_decision_errors"),
...
DIST_MARKERS = [
    ...
    ("built admin source-only manual review clarity", "dist/admin/index.html", "Puedes decidir o modificar esta propuesta manualmente"),
    ("built admin local version pill", "dist/admin/index.html", "localVersionPill"),
    ("built admin local version fallback warning", "dist/admin/index.html", "Local sin sello de versión"),
    ...
    ("built admin review sidebar reset", "dist/admin/index.html", "function resetReviewWorkAreaForNav"),
    ...
    ("built admin source job inside proposal", "dist/admin/index.html", "URL oficial para el agente"),
    ("built admin specialist quality gate", "dist/admin/index.html", "function specialistNoiseReason"),
    ("built admin specialist approval block", "dist/admin/index.html", "Especialistas contiene entradas sospechosas"),
    ("built admin in-card field decisions", "dist/admin/index.html", "function reviewSupportsInlineFieldDecision"),
    ("built admin in-card field decision history", "dist/admin/index.html", "field_decisions"),
