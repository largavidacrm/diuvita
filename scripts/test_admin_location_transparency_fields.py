...
def main() -> None:
    ...
    for marker in [
        ...
        'id="clinicPrimaryLocationKind"',
        'id="clinicPrimaryLocationOnline"',
        ...
        'id="clinicRegistryNumber"',
        'id="clinicProfessionalLicenseNumbers"',
        ...
        "function locationKindValue",
        "function locationIsOnlineKind",
        "function locationsHavePublicAccess",
        "function locationsHavePhysicalLocation",
