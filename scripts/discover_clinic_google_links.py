...
def review_payload(clinic: dict[str, Any], source_url: str, proposed_fields: dict[str, str], candidates: list[GoogleLinkCandidate]) -> dict[str, Any]:
    return {
        "mode": "shadow",
        ...
        "warnings": [
            "Enlaces de Google detectados desde la web oficial; confirmar que abren la ficha correcta antes de guardar."
        ],
...
def process_clinic(
    ...
    candidates = discover_google_links(fetch_result.final_url or website, html_text)
    ...
    if args.apply and proposed_fields:
        payload = review_payload(clinic, fetch_result.final_url or website, proposed_fields, candidates)
