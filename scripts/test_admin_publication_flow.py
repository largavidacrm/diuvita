...
def main() -> None:
    ...
    for marker in [
        ...
        "activeClinicClaimLoadState",
        "Sin claims bloqueantes pendientes",
        "function blockingClaimsMissingLabel",
        "function blockingClaimReviewSubject",
        "function blockingClaimPublicationLabelForClinic",
        "function blockingClaimPublicationDetailForClinic",
        "function validationDisplayLabel",
        "function publicationMissingActionLabel",
        "function actionablePublicationMissingLabels",
        'lower.indexOf("sin claims bloqueantes")',
        'if (/^\\d+\\s+claims?\\s+bloqueantes?[:;]/.test(lower)) return "Resolver " + clean;',
        'return "";',
        "actionablePublicationMissingLabels(clinicPublicationMissingLabels(row))",
        "return actionablePublicationMissingLabels(missing);",
        "var clean = publicationMissingActionLabel(label);",
        "blockingClaimPublicationLabelForClinic(row.id)",
        "blockingClaimPublicationDetailForClinic(row.id)",
        "blockingClaimReviewSubject(firstBlockingClaimReviewForClinic(activeClinic.id))",
        "Abro la revisión bloqueante: ",
