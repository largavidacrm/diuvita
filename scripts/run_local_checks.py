...
TEST_STEPS = [
    ...
    ("test: discovery recommendations", "scripts/test_process_discovery_recommendation_jobs.py"),
    ("test: extract profile jobs", "scripts/test_process_extract_clinic_profile_jobs.py"),
    ...
    ("test: admin visual consistency", "scripts/test_admin_visual_consistency.py"),
    ...
    ("test: admin publication readiness status", "scripts/test_admin_publication_readiness_status.py"),
    ...
    ("test: clinic portal", "scripts/test_clinic_portal.py"),
    ("test: clinic portal activation", "scripts/test_check_clinic_portal_activation.py"),
    ...
    ("test: public neutral order", "scripts/test_public_neutral_order.py"),
    ("test: public clinic recommendations", "scripts/test_public_clinic_recommendations.py"),
    ("test: public city SEO", "scripts/test_public_city_seo.py"),
    ...
    ("test: review LLM batch preflight", "scripts/test_review_llm_batch_preflight.py"),
    ("test: manual review route brief", "scripts/test_manual_review_route_brief.py"),
