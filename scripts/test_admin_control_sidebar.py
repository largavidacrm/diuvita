...
def main() -> None:
    ...
    for marker in [
        ...
        "Añadir a trabajos",
        "Todas las clínicas",
        'type === "EXTRACT_CLINIC_PROFILE" || type === "QUALITY_AUDIT"',
        "selectedAuditClinic ? \"selected_clinic\" : \"all_visible_clinics\"",
        "payload.entity_id = selectedAuditClinic.id",
        "firstHttpUrlFromText(operatorNote)",
